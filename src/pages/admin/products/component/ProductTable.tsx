...
import { deleteProducts, type IProductAdmin } from "../../../../store/adminProductSlice";
        ...
        <div className="min-w-full inline-block align-middle">
          ...
          <div className="relative  text-gray-500 focus-within:text-gray-900 mb-4">
            ...
            <div className="flex justify-between ">
              ...
              />
              <button className="bg-blue-700 rounded text-white" onClick={openModal}>
                Add Product
              </button>
            </div>
          </div>
