...
import { fetchMyOrdersDetails } from "../../store/checkOutSlice";
...
<div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
  <div className="flex justify-start item-start space-y-2 flex-col">
   <h1 className="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-white-800">Order #{orderDetails[0]?.orderId}</h1>
        ...
        orderDetails.length > 0 && orderDetails.map((od)=>{
          return ( 
            ...
            <div className="pb-4 md:pb-8 w-full md:w-40">
              <img className="w-full hidden md:block" src={`http://localhost:3000/${od?.Product?.productImage}`} alt="dress" />
