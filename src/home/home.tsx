    ...
    <div>
      ...
      <main className="text-gray-900 bg-gradient-to-b from-sky-50 to-white">
          ...
          <div className="container mx-auto px-6 lg:flex items-center gap-12">
            <div className="text-center lg:text-left lg:w-1/2 py-8">
              ...
              <p className="text-xl lg:text-2xl mt-6 font-light text-gray-700">
                Shop premium beauty products, book salon services, and get
              ...
              <p className="mt-4 text-gray-600">
                We provide quality products and fast delivery.
              </p>
            </div>
          ...
          <div className="container mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
                <div>
                  <div className="p-8 md:p-12 rounded-lg border border-solid border-gray-200 mb-8 shadow-sm hover:shadow-md transform hover:scale-105 transition-transform duration-300">
                    <p className="font-semibold text-xl">Hair & Styling</p>
                    <p className="mt-4 text-gray-600">
                      Cut, colour, and finish: modern styles and classic looks
                      by our stylists.
                    </p>
                  </div>
                </div>
                <div>
                  <div className="p-8 md:p-12 rounded-lg border border-solid border-gray-200 mb-8 shadow-sm hover:shadow-md transform hover:scale-105 transition-transform duration-300">
                    ...
                    <p className="mt-4 text-gray-600">
                      Facials and treatments using premium skincare lines for
                      glowing results.
                    </p>
                  </div>
                </div>
                <div>
                  <div className="p-8 md:p-12 rounded-lg border border-solid border-gray-200 mb-8 shadow-sm hover:shadow-md transform hover:scale-105 transition-transform duration-300">
                    <p className="font-semibold text-xl">Makeup & Bridal</p>
                    <p className="mt-4 text-gray-600">
                      Bridal makeup and event looks crafted for every occasion.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section id="services" className="py-20">
          <div className="container mx-auto px-6 items-center flex flex-col lg:flex-row gap-8">
            <div className="lg:w-1/2">
            ...
            <div className="mt-10 lg:mt-0 w-full lg:w-1/2">
              ...
              >
                ...
                />
                <circle cx={318} cy="385.41" r={28} fill="#4299e1" />
                <circle cx={448} cy="240.41" r={28} fill="#4299e1" />
                <circle cx={578} cy="313.41" r={28} fill="#4299e1" />
                <circle cx={708} cy="89.41" r={28} fill="#4299e1" />
                <circle cx={958} cy="327.41" r={28} fill="#4299e1" />
                <ellipse
                  cx="233.68"
                  cy="722.61"
                  rx="18.68"
